        ...
        const response = await axios.post( `${ API_URL }chat/completions`, {
          ...
          // 質問内容
            messages: [
              ...
              {'role':'system','content': "料理カテゴリとは「主食、主菜、副菜、乳製品、果物」の5カテゴリから成り立っています、かしこまりました、提案します！等の言葉はいらないので、いきなり料理を出力してください"},
              {'role': 'user','content': "あなたに提案してほしい食事カテゴリは以下の通りです「"+ message + "」、それぞれのカテゴリに属する料理名とその概要を３個ずつ提案してください。概要は一行で述べてください。かしこまりました、提案します！等の言葉はいらないので、いきなり料理を出力してください}}"},
            ],    
        }, {  
          // 送信する HTTP ヘッダー(認証情報) 
        headers: {
